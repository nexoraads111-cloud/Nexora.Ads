...
export default function HomeClient({ html }) {
  return (
    <>
      ...
      <Script src="/js/nexora-config.js?v=11" strategy="afterInteractive" />
      <Script src="/js/script-01.js?v=11" type="module" strategy="afterInteractive" />
      <Script src="/js/main.js?v=11" strategy="afterInteractive" />
