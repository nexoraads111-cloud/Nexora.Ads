...
export default function HomeClient({ html }) {
  return (
    <>
      ...
      <Script src="/js/nexora-config.js?v=10" strategy="afterInteractive" />
      <Script src="/js/script-01.js?v=10" type="module" strategy="afterInteractive" />
      <Script src="/js/main.js?v=10" strategy="afterInteractive" />
